<?php
/**
 * File It USA Inc: Color Patterns
 *
 * @package fileitusa
 ...
 */
function fileitusa_custom_colors_css() {
	...
	/**
	 * Filter File It USA Inc default saturation level.
	 *
	 * @since File It USA Inc 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = apply_filters( 'fileitusa_custom_colors_saturation', 100 );
	$saturation = absint( $saturation ) . '%';

	/**
	 * Filter File It USA Inc default selection saturation level.
	 *
	 * @since File It USA Inc 1.0
	 *
	 * @param int $saturation_selection Selection color saturation level.
	 */
	$saturation_selection = absint( apply_filters( 'fileitusa_custom_colors_saturation_selection', 50 ) );
	$saturation_selection = $saturation_selection . '%';

	/**
	 * Filter File It USA Inc default lightness level.
	 *
	 * @since File It USA Inc 1.0
	 *
	 * @param int $lightness Color lightness level.
	 */
	$lightness = apply_filters( 'fileitusa_custom_colors_lightness', 33 );
	$lightness = absint( $lightness ) . '%';

	/**
	 * Filter File It USA Inc default hover lightness level.
	 *
	 * @since File It USA Inc 1.0
	 *
	 * @param int $lightness_hover Hover color lightness level.
	 */
	$lightness_hover = apply_filters( 'fileitusa_custom_colors_lightness_hover', 23 );
	$lightness_hover = absint( $lightness_hover ) . '%';

	/**
	 * Filter File It USA Inc default selection lightness level.
	 *
	 * @since File It USA Inc 1.0
	 *
	 * @param int $lightness_selection Selection color lightness level.
	 */
	$lightness_selection = apply_filters( 'fileitusa_custom_colors_lightness_selection', 90 );
	...
	/**
	 * Filters File It USA Inc custom colors CSS.
	 *
	 * @since File It USA Inc 1.0
	 *
	 ...
	 */
	return apply_filters( 'fileitusa_custom_colors_css', $theme_css, $primary_color, $saturation );
}
